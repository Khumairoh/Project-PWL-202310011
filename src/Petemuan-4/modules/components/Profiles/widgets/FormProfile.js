            ...
            <div style={{marginTop:'7rem'}} className='card '>
                <div className="card-header">
                    <h3 style={{justifyContent:'center', alignItems: 'center', textAlign:'center'}} className="card-title align-items-start flex-column">
                        <span style={{ textAlign:'center' }} className="card-label fw-bolder text-dark">Form Data User</span><br/>
                ...
                <div className="card-body">
                    <form className='form-profile' method='post' onSubmit={(e) => handlerSubmit(e)} id="form-profile" >
                        ...
                        <div className="text-center " style={{marginLeft: '14rem'}}>
                            <button style={{width:'7rem', backgroundColor:'Gray', marginTop:'10px' }} type="button" className='btn btn-lg '>CLEAR</button>
                            <button style={{width:'7rem', backgroundColor:'Gray', marginTop:'10px', marginLeft: '-250px'}} type="submit" className='btn btn-lg  mx-2 btn-submit'>SUBMIT</button>
                        </div>
                    </form>
                </div>
            </div>
